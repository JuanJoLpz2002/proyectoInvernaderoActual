...
class InventarioController {
    ...
    listOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const respuesta = yield database_1.default.query('SELECT * FROM inventario WHERE id_planta = ?', [id]);
    ...
    actualizarInv(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            //console.log(req.params);
            console.log(id);
            const resp = yield database_1.default.query("UPDATE inventario set ? WHERE id_planta = ?", [req.body, id]);
            res.json(resp);
            //res.json(null);
        });
    }
